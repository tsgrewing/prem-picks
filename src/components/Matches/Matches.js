...
function Matches() {
  ...
  // async function updateCompetition (comp) {
  ...
  const Modal = () => {
    ...
    return (
      ...
      <div className="ml-auto mr-auto relative w-64">
        {/* <select defaultValue={"default"} className="block w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline" onChange={event => updateCompetition(event.target.value)}>
          <option value={"default"} disabled>Choose Competition</option>
